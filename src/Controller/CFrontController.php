...
class CFrontController{
    ...
    private function checkPermissions($controller, $method) {

        $permissions = [
            'utente' => ['logout','userDataSection', 'userDataForm', 'userHistoryOrders', 'deleteAccount', 'changeUserData', 'changePass']

        ];

        return isset($permissions[$controller]) && in_array($method, $permissions[$controller]);
    }
}
    */
